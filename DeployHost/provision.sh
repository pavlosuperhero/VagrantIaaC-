...
sudo sed -i 's/#PasswordAuthentication yes/PasswordAuthentication yes/g' /etc/ssh/
sudo sed -i 's/PasswordAuthentication no/#PasswordAuthentication no/g' /etc/ssh/
